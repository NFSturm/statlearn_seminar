...
```{r}
ggplot(accuracies_df, aes(nbagg, accuracy)) + geom_point() + geom_line() + theme_classic() + labs(title = "Genauigkeitsmaß nach Anzahl der Bootstrap-Replikationen", caption = "Verwendung 25 diskreter Werte") + xlab("Anzahl der aggregierten Bäume") + ylab("Genauigekeit") + scale_y_continuous(limits = c(0.8, 0.86))
```
