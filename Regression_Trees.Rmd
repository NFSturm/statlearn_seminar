...
Das beste Modell für eine Lernrate von 0.01 und der Aggregation von 2000 Bäumen erreicht einen kreuvalidierten RMSE-Wert von etwa 380. Hier lässt sich die Entwicklung des Testfehlers mit Variation der Lernrate visualisieren.
...
Das oben konstruierte Random-Forest-Modell erreicht für den Test-Datensatz einen Fehler von 334. Zusätzlich lässt sich der RMSE als Funktion von mtry gut veranschaulichen. 
...
Weiterhin lässt sich ebenso die Variablen-Wichtigkeit darstellen.
